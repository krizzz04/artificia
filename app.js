    ...
    <td>${studentMarks.subjects.rmip.ia3.attendance}</td>
            ...
            <div class="right">
                ...
                <div class="leaves">
                    ...
                    <div class="teacher">
                        <div class="profile-photo"><img src="./images/majeed.png" alt=""></div>
                        <div class="info">
                            <h3>Abdul majeed</h3>
                    ...
                    <div class="teacher">
                        <div class="profile-photo"><img src="./images/ramya.png" alt=""></div>
                        <div class="info">
                            <h3>Ramya</h3>
                    ...
                    <div class="teacher">
                        <div class="profile-photo"><img src="./faculty/abonas.jpg" alt=""></div>
                        <div class="info">
                            <h3>Abinas</h3>
                            <small class="text-muted">Full Day</small>
                        </div>
